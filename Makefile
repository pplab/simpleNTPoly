...
simple_ntpoly_test.o: simple_ntpoly_test.cpp
	$(CXX) $(CXXFLAGS) $(NTPOLY_INC) -c simple_ntpoly_test.cpp

simple_ntpoly.o: simple_ntpoly.cpp
	$(CXX) $(CXXFLAGS) $(NTPOLY_INC) -D__NTPOLY -c simple_ntpoly.cpp
...
utils.o: utils.cpp
	$(CXX) $(CXXFLAGS) $(NTPOLY_INC) -c utils.cpp
