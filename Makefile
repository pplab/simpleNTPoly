...
test_loadBCDMatrixFromABACUSFile: test_loadBCDMatrixFromABACUSFile.o utils.o
	$(CXX) $(CXXFLAGS) -o test_loadBCDMatrixFromABACUSFile test_loadBCDMatrixFromABACUSFile.o utils.o \
		-L$(NTPOLY_DIR) $(NTPOLY_LIB) \
		-L$(LIB_DIR) $(SCALAPACK_LIB) $(LAPACK_LIB) $(BLAS_LIB) $(MATH_LIBS) \
		$(OPENMPI_F_LIB) $(FORTRAN_LIB)
